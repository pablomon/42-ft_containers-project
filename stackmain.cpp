...
{
	{
		...
		//Reverse iterators
		{
			...
			mapa.insert(NS::pair<std::string, std::string>("k1", "v1"));
			mapa.insert(NS::pair<std::string, std::string>("k2", "v2"));
			mapa.insert(NS::pair<std::string, std::string>("k3", "v3"));
			printmap(mapa, "mapa");

			std::cout << ".................." << std::endl;
			NS::map<std::string, std::string>::reverse_iterator it = mapa.rbegin();
			while (it != mapa.rend())
			{
				std::cout << "first = ";
				std::cout << it->first << std::endl;
			...
			std::cout << "End reverse iterator" << std::endl;
		}
	}
		return 0;
